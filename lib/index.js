var _, a, b, c, changeString, colorParser, commandlineConfig, defaultConfigFile, err, error, fs, homeDirectory, lifx, lifxObj, lifxclIcon, log, makeConfig, notifier, notify, o, parsedColor, path, ref, selection, setProp;
...
if (o.toggle != null) {
  ...
  lifx.togglePower(selection, console.log);
} else if (o.off != null) {
