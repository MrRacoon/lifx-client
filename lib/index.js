var ColorState, colorParser, e, err, fileContents, fileLocation, fs, getStatus, home, lifx, lifxObj, log, notifier, notify, o, opts, path, power, setProp, t, token, tokenObj, verbose, writeToLogFile,
  slice = [].slice;
